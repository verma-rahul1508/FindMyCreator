...
export default function ContentAndNichePage() {
  ...
  const save = async (continueToNext: boolean) => {
    ...
    setContentProfileExists(true);
    if (continueToNext) router.push('/profile/social'); else { setSaving(false); router.push('/profile'); }
  };
