...
declare
  ...
  v_min_followers bigint := p_min_followers;
  v_max_followers bigint := p_max_followers;
  v_min_completion integer := p_min_completion;
  v_max_completion integer := p_max_completion;
